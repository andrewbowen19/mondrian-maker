...
class mondrian():
    ...
    @classmethod
    def make_mondiran(self, x=None, y=None, bins=None, gridlines: bool =  True, title=False, savefig=False):
        """
...
if __name__ == "__main__":
    ...
    my_x = np.random.random(100)
    my_y = np.random.random(my_x.size)
    # Generating some # of plots
    for _ in range(0, n_plots):
        m.make_mondiran(my_x, my_y)
